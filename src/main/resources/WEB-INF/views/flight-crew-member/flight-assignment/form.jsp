...
<acme:form>
	<acme:input-textbox code="flight-crew-member.flight-assignment.form.label.flightCrewDuty" path="flightCrewDuty"/>
	<acme:input-moment code="flight-crew-member.flight-assignment.form.label.lastUpdate" path="lastUpdate"/>
	<acme:input-textbox code="flight-crew-member.flight-assignment.form.label.assignmentStatus" path="assignmentStatus"/>
	...
	<acme:input-textbox code="flight-crew-member.flight-assignment.form.label.legStatus" path="leg.legStatus" readonly="true"/>
