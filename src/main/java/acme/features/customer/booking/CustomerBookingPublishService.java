...
public class CustomerBookingPublishService extends AbstractGuiService<Customer, Booking> {
	...
	public void validate(final Booking booking) {
		...
		cardNibbleStored = booking != null && booking.getLastCardNibble() != null && !booking.getLastCardNibble().isBlank() && booking.getLastCardNibble().length() >= 4;

		super.state(cardNibbleStored, "lastCardNibble", "acme.validation.booking.lastCardNibble.message");
